      ...
      <div className="hidden lg:flex lg:w-1/3 bg-gradient items-center justify-center p-6">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="absolute bottom-8 text-center px-4">
            ...
            <p className="text-white opacity-80 drop-shadow-md">A lovable lunatic with a PhD in mayhem and a knack for bad decisions!--- MY gf knows her better you can ask her</p>
          </div>
        </div>
      </div>
